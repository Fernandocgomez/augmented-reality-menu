...
export class RestaurantOwnerController {
    ...
    @Patch(':id')
    async updateRestaurantOwner(@Param('id') restaurantOwnerId: string, @Body() updateRestaurantOwnerDto: UpdateRestaurantOwnerDto): Promise<RestaurantOwnerUpdatedDto> {
        return this.restaurantOwnerService.updateRestaurantOwner(restaurantOwnerId, updateRestaurantOwnerDto);
    }

    @Delete(':id')
    async deleteRestaurantOwner(@Param('id') restaurantOwnerId): Promise<RestaurantOwnerDeleted> {
